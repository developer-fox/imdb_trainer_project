...
class MainScreenHomeViewTopRatedItem extends StatefulWidget {
  ...
  MainScreenHomeViewTopRatedItem({
    Key? key,
  ...
  @override
  State<MainScreenHomeViewTopRatedItem> createState() => _MainScreenHomeViewTopRatedItem();
}

class _MainScreenHomeViewTopRatedItem extends State<MainScreenHomeViewTopRatedItem> {
  @override
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          padding: EdgeInsets.symmetric( horizontal: widget.type== "movie" ?  22: 10),
                          side: BorderSide(
                            width: 1,
                        ...
                        onPressed: (){},
                        child:  Text(
                          widget.type== "cinema" ? "Gosterim Saatleri" : "+ İzleme Listesi",
                      ...
                      Align(
                        ...
                        child: IconButton(
                          onPressed: (){},
                           icon: Icon(Icons.info_outline_rounded, color: Colors.white60, size: 32,)),
                      )
