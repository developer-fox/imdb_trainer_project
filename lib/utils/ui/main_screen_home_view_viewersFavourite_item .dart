...
class MainScreenHomeViewViewersFavouriteItem extends StatefulWidget {
  ...
  MainScreenHomeViewViewersFavouriteItem({
    Key? key,
  ...
  @override
  State<MainScreenHomeViewViewersFavouriteItem> createState() => _MainScreenHomeVieViewersFavouritedItem();
}

class _MainScreenHomeVieViewersFavouritedItem extends State<MainScreenHomeViewViewersFavouriteItem> {
  @override
